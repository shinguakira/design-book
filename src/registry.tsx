...
export const sections: Section[] = [
  {
    ...
    entries: [
      ...
      },
      {
        ...
        description:
          "「選択UI」16パターン。combobox / multi chips / tag / 色 / アバター / segmented / radio cards / listbox まで。",
      ...
      },
      {
        ...
        description:
          "ドロップダウン1行の「スロット構成」20種。データ違い (flag/currency/tz) は集約し、レイアウト差だけ残した。",
      ...
      },
      {
        ...
        description:
          "日付/時刻の入力 24種。表現14 (native/mask/calendar/wheel/dial) + シナリオ10 (生年月日/予約/宿泊/リマインダー/定期/締切/空き時間/四半期)。",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        title: "Numbered List",
        description:
          "番号+名前の1行リスト20パターン。ランキング・目次・To-do・神話風・コレクション。",
      ...
      },
      {
        ...
        title: "List Layouts",
        description:
          "リストの並べ方・密度・操作の付け方 16パターン。Bento・Tree・Switchable・Bulk・Skeletonまで。",
      ...
      },
      {
        ...
        title: "Table Layouts",
        description:
          "テーブル32パターン。罫線・密度・Hover・Vertical zebra・点線・Dark header から、Sort/Filter/Select/Edit/Heatmap/Sticky まで。",
      ...
      },
      {
        ...
        title: "Sort UI",
        description:
          "並べ替え UI 12種。Native/Inline/Split/Segmented/Table header/Badge/Menu/Multi-key/Smart 等。",
      ...
      },
      {
        ...
        title: "Mouse Effects",
        description:
          "光の粒トレイル / カスタムカーソル / スポットライト / 波紋 / キラキラ / 3D傾き / 磁石ボタン 等9種。",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        slug: "bento",
        title: "Bento Design",
        description: "非対称グリッド。Apple WWDC で再普及した SaaS LP 新定番。",
        Component: lz(() => import("./pages/styles/BentoDesign")),
      },
      {
        slug: "editorial",
        title: "Editorial / Magazine",
        description: "雑誌組版を Web に。Serif + ドロップキャップ + 段組。",
        Component: lz(() => import("./pages/styles/Editorial")),
      },
      {
        slug: "bauhaus",
        title: "Bauhaus",
        description: "原色 (赤青黄) + 基本図形 (◯△□)。100年経っても古びない。",
        Component: lz(() => import("./pages/styles/Bauhaus")),
      },
      {
        slug: "memphis",
        title: "Memphis",
        description: "1980s イタリアの原色カオス。ドット・ジグザグ・三角。",
        Component: lz(() => import("./pages/styles/Memphis")),
      },
      {
        slug: "vaporwave",
        title: "Vaporwave",
        description: "紫ピンク + グリッド + 太陽。80sのレトロ未来感。",
        Component: lz(() => import("./pages/styles/Vaporwave")),
      },
      {
        slug: "y2k",
        title: "Y2K",
        description: "2000年前後の半透明シルバー + 虹色反射。Z世代で再評価中。",
        Component: lz(() => import("./pages/styles/Y2K")),
      },
      {
        slug: "cyberpunk",
        title: "Cyberpunk / Glitch",
        description: "黒+ネオン+カタカナ+グリッチ。Web3/ゲーミング系。",
        Component: lz(() => import("./pages/styles/Cyberpunk")),
      },
      {
        slug: "hand-drawn",
        title: "Hand-drawn / Sketch",
        description: "手描きアウトライン + 筆記体。Excalidraw / tldraw 系。",
        Component: lz(() => import("./pages/styles/HandDrawn")),
      },
      {
        slug: "pixel-art",
        title: "Pixel Art / 8-bit",
        description: "ドット絵。インディーゲームLPの定番。",
        Component: lz(() => import("./pages/styles/PixelArt")),
      },
      {
        slug: "design-systems",
        title: "Design Systems (Apple/Fluent/M3/Carbon)",
        description: "4大企業デザインシステムの「指紋」を同じカードで比較。",
        Component: lz(() => import("./pages/styles/DesignSystems")),
      },
      {
        slug: "synthwave",
        title: "Synthwave / Retrowave",
        description: "80s カーチェイス+遠近グリッド+山+太陽。Stranger Things系。",
        Component: lz(() => import("./pages/styles/Synthwave")),
      },
      {
        slug: "web1",
        title: "Web 1.0 / 90s Nostalgia",
        description: "テーブル+Comic Sans+工事中GIF+Marquee。Geocities期。",
        Component: lz(() => import("./pages/styles/Web1")),
      },
      {
        slug: "art-deco",
        title: "Art Deco",
        description: "1920s。ゴールド+対称+幾何装飾+太いセリフ。高級感。",
        Component: lz(() => import("./pages/styles/ArtDeco")),
      },
      {
        slug: "art-nouveau",
        title: "Art Nouveau",
        description: "1900s。植物・蔓・女性像の曲線。ミュシャ・クリムト。",
        Component: lz(() => import("./pages/styles/ArtNouveau")),
      },
      {
        slug: "mid-century",
        title: "Mid-century Modern",
        description: "1950-60s。木目・ティール・マスタード・Helvetica・Eames。",
        Component: lz(() => import("./pages/styles/MidCentury")),
      },
      {
        slug: "swiss",
        title: "Swiss / International Style",
        description: "グリッド+Helvetica+黒赤。モダニズム UI の源流。",
        Component: lz(() => import("./pages/styles/Swiss")),
      },
      {
        slug: "aurora",
        title: "Aurora / Mesh Gradient",
        description: "ぼかし多色グラデ。Stripe / Linear / Vercel が代表。",
        Component: lz(() => import("./pages/styles/Aurora")),
      },
      {
        slug: "maximalism",
        title: "Maximalism",
        description: "Minimalism の対極。装飾・色・パターンを盛り盛り。",
        Component: lz(() => import("./pages/styles/Maximalism")),
      },
      {
        slug: "isometric",
        title: "Isometric",
        description: "30度等角投影で擬似3D。SaaS説明イラスト・ゲーム。",
        Component: lz(() => import("./pages/styles/Isometric")),
      },
      {
        slug: "paper-cut",
        title: "Paper Cut / Origami",
        description: "紙を重ねた層感+柔らかい影。絵本・教育系。",
        Component: lz(() => import("./pages/styles/PaperCut")),
      },
      {
        slug: "solarpunk",
        title: "Solarpunk",
        description: "Cyberpunk のアンチ。緑+太陽+植物+持続可能テック。",
        Component: lz(() => import("./pages/styles/Solarpunk")),
      },
      {
        slug: "frutiger-aero",
        title: "Frutiger Aero",
        description: "2004-2013。Windows Vista / 初期 iOS の光沢+バブル。",
        Component: lz(() => import("./pages/styles/FrutigerAero")),
      },
      {
        slug: "liquid-glass",
        title: "Liquid Glass (visionOS)",
        description: "Apple visionOS / iOS 26。屈折+光反射の次世代マテリアル。",
        Component: lz(() => import("./pages/styles/LiquidGlass")),
      },
      {
        slug: "wabi-sabi",
        title: "Wabi-sabi",
        description: "侘び寂び。不完全・揺らぎ・余白。伝統工芸 EC。",
        Component: lz(() => import("./pages/styles/WabiSabi")),
      },
      {
        slug: "anti-design",
        title: "Anti-design",
      ...
      },
      {
        ...
        description:
          "有名サイトの「指紋」12社カタログ。Stripe/Linear/Vercel/Apple/Notion/Airbnb/Spotify/Discord/GitHub/Anthropic/YouTube/Tailwind。",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        description:
          "3択の「置き方」12種。segmented/card/dropdown/cycle/slider/dial/wheel/radial/venn/split/z-stack。構造が違うものだけ。",
    ...
    entries: [
      {
        ...
        title: "Headers",
        description:
          "Marketing / App / Centered / Transparent / Mobile / Sticky / Banner付 など9パターン。",
      ...
      },
      {
        ...
        description:
          "右ドロワー覆う / 領域分割 / 左 / ボトムシート / モーダル / インライン展開 / ページ遷移。",
