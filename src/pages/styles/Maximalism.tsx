...
export default function Maximalism() {
  return (
    <StyleDoc
      ...
      cons={["情報整理・読みやすさは犠牲", "デザインの「線引き」が難しい", "雑に作ると単に汚い"]}
      example={
        <div
          className="p-6 rounded-md relative overflow-hidden"
          style={{
            background: "repeating-linear-gradient(45deg, #fde68a 0 20px, #fef3c7 20px 40px)",
          }}
        >
          <div
          ...
          <div
            ...
            style={{
              background: "linear-gradient(135deg, #fbcfe8 0%, #c084fc 50%, #38bdf8 100%)",
