        ...
        >
          ...
          <div
            ...
            style={{
              ...
              boxShadow: "inset 0 1px 0 rgba(255,255,255,0.9), 0 8px 32px rgba(0, 50, 100, 0.3)",
            }}
          >
            <div
            ...
            <div className="flex gap-2">
              <button
                ...
                style={{
                  background: "linear-gradient(180deg, #67a8e6 0%, #2d5a90 50%, #1c4778 100%)",
                  boxShadow:
              ...
              <button
                ...
                style={{
                  color: "#0c4a6e",
                  background: "linear-gradient(180deg, #fff 0%, #d4d4d8 50%, #a1a1aa 100%)",
                  boxShadow: "inset 0 1px 0 rgba(255,255,255,0.7), 0 2px 4px rgba(0,0,0,0.15)",
                }}
              >
                Cancel
              </button>
