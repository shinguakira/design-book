        ...
        >
          <div className="max-w-sm mx-auto">
            <div className="flex items-baseline gap-4 mb-6">
              ...
              <div className="text-[10px] tracking-[0.5em]" style={{ color: "#5a3a18" }}>
                W A B I — S A B I
              </div>
            </div>
            <div className="h-px my-6" style={{ background: "#5a3a18", opacity: 0.3 }} />
            <div
            ...
            <svg viewBox="0 0 80 30" className="mx-auto mt-6" width={80} height={30}>
              <path
