...
function Stripe() {
  return (
    <div
      ...
      style={{
        background: "linear-gradient(135deg, #fff6ed 0%, #ffe1d2 25%, #c9e5ff 65%, #e1d5ff 100%)",
      }}
    >
      <div className="relative max-w-md">
        <div className="text-[10px] uppercase tracking-[0.2em] mb-2" style={{ color: "#635bff" }}>
    ...
    <div className="p-10 bg-black">
      <div className="max-w-md text-center mx-auto">
        ...
        <p className="text-sm mt-3" style={{ color: "#a3a3a3" }}>
          Vercel's Frontend Cloud gives developers frameworks, workflows, and infrastructure to
...
function Apple() {
  return (
    ...
    >
      <div className="text-[10px] font-semibold text-white mb-2 tracking-wider">MacBook Pro</div>
      <div
...
function Notion() {
  return (
    <div className="p-8" style={{ background: "#fff", color: "#37352f" }}>
      <div className="text-xs mb-3" style={{ color: "#37352f80", fontFamily: "serif" }}>
    ...
    <div className="p-8 bg-white">
      ...
      <div className="grid grid-cols-3 gap-3">
        {[
          ...
          <div key={p.name}>
            <div className={`aspect-square rounded-xl bg-gradient-to-br ${p.color} relative`}>
  ...
  return (
    <div className="bg-black p-6">
      <div
        ...
        style={{
          background: "linear-gradient(180deg, #1f4f3f 0%, #121212 100%)",
        }}
      >
        <div className="flex gap-4">
          <div
            ...
            style={{
              background: "linear-gradient(135deg, #1db954 0%, #1ed760 50%, #82e0aa 100%)",
            }}
          />
          <div className="flex-1 text-white">
            <div className="text-[10px] uppercase tracking-wider opacity-80">Playlist</div>
            <div className="text-3xl font-black tracking-tight mt-1">Today's Top Hits</div>
...
function Discord() {
  return (
    <div className="flex" style={{ background: "#313338", minHeight: 220 }}>
      <div className="p-2 flex flex-col gap-2" style={{ background: "#1e1f22", width: 60 }}>
        <div
      ...
      <div className="p-2" style={{ background: "#2b2d31", width: 180 }}>
        <div className="px-2 py-2 text-white font-bold text-sm">🎮 Game Squad</div>
        <div
          className="px-1 mt-2 text-[10px] uppercase tracking-wider"
          style={{ color: "#80848e" }}
        >
          Text Channels
        </div>
        ...
        <div className="flex gap-2 mb-3">
          ...
          <div>
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-[10px]" style={{ color: "#80848e" }}>
                今日 12:34
              </span>
            </div>
  ...
  return (
    <div style={{ background: "#0d1117" }} className="p-6">
      <div className="flex items-center gap-2 text-sm" style={{ color: "#c9d1d9" }}>
        <span style={{ color: "#58a6ff" }} className="font-medium">
          acme-org
        </span>
...
function Anthropic() {
  return (
    <div className="p-8" style={{ background: "#f5efe6" }}>
      <div className="text-[10px] uppercase tracking-[0.32em] mb-3" style={{ color: "#cc785c" }}>
        ANNOUNCEMENT
      </div>
      <h1
...
function Tailwind() {
  return (
    <div className="p-8 bg-white">
      <div className="text-3xl font-extrabold tracking-tight" style={{ color: "#0f172a" }}>
      ...
      <div className="mt-4 flex gap-2">
        ...
        <button className="px-4 h-10 rounded-md text-sm font-semibold border border-zinc-300 inline-flex items-center gap-2">
          ...
          Quick search...
          <span className="text-xs text-zinc-500 border border-zinc-300 rounded px-1.5">⌘K</span>
        </button>
      </div>
    </div>
  );
  ...
  return (
    <div className="max-w-5xl space-y-6">
      <p className="text-sm text-zinc-700 leading-relaxed">
        実在する有名サイトのデザインを「指紋」として並べたカタログ。 色・タイポ・余白・CTA
        の選び方が会社ごとに大きく違うのが分かる。
      </p>
      ...
      <section className="rounded-lg border border-blue-200 bg-blue-50 p-5 text-sm text-blue-900">
        ...
        <ul className="list-disc pl-5 space-y-1">
          <li>
            <b>色</b> — 1色のアクセント (Stripe紫 / Linear紫 / Airbnb桃 / Spotify緑 / YouTube赤 /
            Anthropic テラコッタ) で識別される
          </li>
          <li>
            <b>タイポ</b> — Sans serif (Vercel/Linear) vs Serif (Notion/Anthropic) で 印象が真逆
          </li>
          <li>
