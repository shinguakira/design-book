  ...
  return (
    <div className="max-w-5xl space-y-6">
      <p className="text-sm text-zinc-700 leading-relaxed">
        ...
        それぞれどう違うかを見る。Apple HIG / Fluent (Microsoft) / Material You (Google) / Carbon
        (IBM) の4種を例で。
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        <Frame label="Fluent (Microsoft / Win11)" note="Acrylic blur・直角寄り・Segoe">
          <div
            ...
            style={{
              background: "linear-gradient(135deg, rgba(255,255,255,0.85), rgba(245,245,250,0.78))",
              border: "1px solid rgba(0,0,0,0.05)",
              boxShadow: "0 8px 16px rgba(0,0,0,0.08), inset 0 1px 0 rgba(255,255,255,0.7)",
        ...
        <Frame label="Material You (Google M3)" note="動的カラー・丸ボタン・Roboto Flex">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <div className="text-sm font-medium text-[#1d1b20]">新着通知</div>
        ...
        <Frame label="Carbon (IBM)" note="エンタープライズ・厳格グリッド・Plex">
          ...
          >
            <div className="flex items-center gap-3 border-b border-zinc-200 pb-3">
              ...
              <div className="flex-1">
                <div className="text-sm font-semibold text-[#161616]">新着通知</div>
      ...
      <section className="rounded-lg border border-blue-200 bg-blue-50 p-5 text-sm text-blue-900">
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>一見似ているが、FAB / カード / ボタン などに明確な「指紋」がある。</li>
        </ul>
      </section>
    </div>
  );
