      ...
      example={
        <div className="p-10 bg-white rounded-md border border-zinc-200">
          <div className="max-w-md mx-auto grid grid-cols-12 gap-2">
            <div className="col-span-12" style={{ borderBottom: "4px solid #000" }}>
              <div
            ...
            <div className="col-span-7 mt-4">
              ...
              >
                Function. Grid. Typography. The three pillars of the International Style —
                formulated in Zürich and Basel — still define how clean systems are built today.
              </div>
            </div>
            ...
            <div className="col-span-12 mt-4" style={{ borderTop: "1px solid #000" }}>
              <div
