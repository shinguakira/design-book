    ...
    <StyleDoc
      ...
      example={
        <div
          ...
          style={{
            background:
              'radial-gradient(circle at 25% 25%, #c4d6f0 0%, #6a91d6 60%, #2e4f8a 100%)',
          }}
        >
          <div
          ...
          >
            <div
              ...
              style={{
                background:
                  'linear-gradient(90deg, #ff80ed, #80f9ff, #ffe680, #80ff95, #ff80ed)',
                opacity: 0.7,
              }}
            />
            <div
            ...
            <div className="mt-4 flex gap-2">
              <button
                ...
                style={{
                  background:
                    'linear-gradient(180deg, #8fbef5 0%, #2d5a90 100%)',
                  boxShadow:
                    'inset 0 1px 0 rgba(255,255,255,0.6), 0 2px 4px rgba(0,0,0,0.3)',
              ...
              <button
                ...
                style={{
                  background:
                    'linear-gradient(180deg, #f5f5f5 0%, #b0b0b0 100%)',
                  boxShadow:
                    'inset 0 1px 0 rgba(255,255,255,0.7), 0 2px 4px rgba(0,0,0,0.2)',
                }}
              >
                Cancel
              </button>
