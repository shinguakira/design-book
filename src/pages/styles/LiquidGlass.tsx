...
export default function LiquidGlass() {
  return (
    <StyleDoc
      ...
      pros={["最新感・空間性", "背景コンテキストを保持しつつレイヤー化", "AR / VR との親和性"]}
      cons={[
      ...
      example={
        <div
          ...
          style={{
            background: "linear-gradient(135deg, #1e3a8a 0%, #6b21a8 50%, #c2410c 100%)",
            minHeight: 260,
          }}
        >
          {/* light streaks */}
          ...
          <div
            ...
            style={{
              ...
              width: 180,
              height: 80,
              background: "radial-gradient(ellipse, rgba(192,132,252,0.7) 0%, transparent 70%)",
              filter: "blur(25px)",
            }}
          />
          ...
          >
            ...
            <div className="text-white">
              ...
              <div className="text-sm opacity-80 mt-1">屈折・反射・歪み — 空間に浮かぶレンズ。</div>
