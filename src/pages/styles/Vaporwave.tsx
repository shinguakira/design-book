          ...
          >
            <div
              ...
              style={{
                width: 140,
                height: 140,
                background: "radial-gradient(circle, #ffeb3b 0%, #ff6f61 55%, transparent 100%)",
              }}
            />
            <div
          ...
          <div className="relative pt-24 pb-8 text-center">
            <div
              ...
              style={{
                color: "#fff",
                fontFamily: "serif",
                textShadow: "0 0 12px #ff00ff, 3px 3px 0 #00ffff, -2px -2px 0 #ff00ff",
              }}
            >
              VAPOR
            </div>
            <div className="mt-2 text-xs tracking-[0.4em]" style={{ color: "#ffb3ff" }}>
              A E S T H E T I C
            </div>
            <button
