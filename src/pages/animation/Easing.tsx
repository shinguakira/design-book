  ...
  return (
    <div className="max-w-5xl space-y-6">
      <p className="text-sm text-zinc-700">
        同じ距離・同じ時間でも、イージング曲線でまったく別の印象になる。
        ボールは自動で行き来します。「ease-out + 200ms」が一番ハズさない安全牌。
      </p>
          ...
          >
            ...
            <div className="p-4 relative h-16">
              ...
              <div
                ...
                style={{
                  animation: `easing-demo 2.6s ${e.name} infinite`,
                }}
              />
            </div>
          </div>
      ...
      <style>{`
        @keyframes easing-demo {
          ...
          8% { left: 1rem; opacity: 1; }
          48% { left: calc(100% - 3.5rem); opacity: 1; }
          56% { left: calc(100% - 3.5rem); opacity: 0; }
          100% { left: 1rem; opacity: 0; }
        }
      `}</style>
