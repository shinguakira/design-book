    ...
    <ShowcaseGrid>
      <ShowcaseRow label="Tones">
        <div className="w-full space-y-2">
          ...
          <Banner tone="warning">メンテナンスを予定しています (12/24 02:00 - 04:00)。</Banner>
          <Banner tone="error">一部機能で障害が発生しています。復旧作業中です。</Banner>
        </div>
      </ShowcaseRow>
      <ShowcaseRow label="Closable">
        <div className="w-full">
          {open ? (
            ...
            <button className="text-xs text-zinc-500 underline" onClick={() => setOpen(true)}>
              戻す
            </button>
          )}
        </div>
